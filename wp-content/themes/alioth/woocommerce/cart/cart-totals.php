...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <div cellspacing="0" class="shop_table shop_table_responsive ct-prices">
        ...
        <div class="ct-prices">
            ...
            <div class="ct-sub-total"><?php esc_html_e( 'Subtotal:', 'woocommerce' ); ?><span data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></span></div>
        ...
        <div class="ct-total order-total">
