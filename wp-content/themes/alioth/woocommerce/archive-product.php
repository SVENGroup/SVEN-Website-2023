...
if (class_exists('Redux')) {
    ...
    if ($option['animate_shop_title'] != false) {
        $animTitle = 'true';
    }
    
    $pageHeader = $option['shop_page_header'];
    $shopPageTitle = $option['shop_page_title'];
};
...
<div data-anim="true" class="page-header shop-page-header">
    ...
    <div class="page-header-wrap wrapper-small">
        ...
        <div class="page-title" data-anim="<?php echo esc_attr($animTitle); ?>">
            ...
            <h1 class="big-title woocommerce-products-header__title page-title"><?php echo esc_html($option['shop_page_title']) ?></h1>
            <?php endif; ?>
        </div>
        <!-- /Page Title -->
